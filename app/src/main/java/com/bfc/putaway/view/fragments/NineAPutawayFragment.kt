...
import com.bfc.putaway.databinding.FragmentNineAPutawayBinding
 ...
 * Use the [NineAPutawayFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class NineAPutawayFragment : Fragment() {
...
//    private var edit_type: EditText? = null
    private lateinit var binding: FragmentNineAPutawayBinding
    ...
    fun fabClickedData() {
        ...
        listener?.onFabInteraction(965, listofButton, mMap)
    }
    ...
    override fun onCreateView(
        ...
        binding = FragmentNineAPutawayBinding.inflate(inflater, container, false)

//        val rootView = inflater.inflate(R.layout.fragment_nine_a_putaway, container, false)
...
//        edit_type = rootView.findViewById<EditText>(R.id.edit_type)
    ...
    companion object {
         ...
         * @return A new instance of fragment NineAPutawayFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            NineAPutawayFragment().apply {
    ...
    override fun onDestroyView() {
        super.onDestroyView()
        PutAwayBaseActivity.currentFragment = NineAPutawayFragment()
    }
    ...
    fun onNextClick(btnValue: String) {
        ...
        listener?.onNextInteraction(965, btnValue, mMap)
    }
