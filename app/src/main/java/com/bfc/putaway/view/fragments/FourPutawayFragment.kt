...
import com.bfc.putaway.databinding.FragmentFourPutawayBinding
 ...
 * Use the [FourPutawayFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class FourPutawayFragment : Fragment() {
...
//    private var edit_qty: EditText? = null
    private lateinit var binding: FragmentFourPutawayBinding
    ...
    fun fabClickedData() {
        ...
        val mMap = ArrayMap<String, String>().apply {
            put("quantity", "" + binding.editQty?.text.toString())
        }

        listener?.onFabInteraction(4, listofButton, mMap)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (mMineUserEntity != null && mMineUserEntity.Output != null) {
            if (!mMineUserEntity.Output.w4item.isNullOrEmpty()) {
                binding.tvDataAny?.text = mMineUserEntity.Output.w4item
            }

            /*if (!mMineUserEntity.Output.des02.isNullOrEmpty()) {
                edit_qty?.setText(mMineUserEntity.Output.des02)
            }*/
    ...
    override fun onCreateView(
        ...
        binding = FragmentFourPutawayBinding.inflate(inflater, container, false)
//        val rootView = inflater.inflate(R.layout.fragment_four_putaway, container, false)
...
//        edit_qty = rootView.findViewById<EditText>(R.id.edit_qty)
    ...
    companion object {
         ...
         * @return A new instance of fragment FourPutawayFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FourPutawayFragment().apply {
    ...
    override fun onDestroyView() {
        super.onDestroyView()
        PutAwayBaseActivity.currentFragment = FourPutawayFragment()
    }
    ...
    fun onNextClick(btnValue: String) {
        ...
        listener?.onNextInteraction(4, btnValue, mMap)
    }
    ...
    fun updateUiOnScan(decodedData: String) {
        binding.editQty.setText(decodedData)
