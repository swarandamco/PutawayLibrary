...
import com.bfc.putaway.databinding.FragmentTenPutawayBinding
 ...
 * Use the [TenPutawayFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class TenPutawayFragment : Fragment() {
    // TODO: Rename and change types of parameters
    private var param1: String? = null
    private var param2: String? = null
//    private var tv_wareHouse: TextView? = null
//    private var edit_aisle: EditText? = null
    private lateinit var binding: FragmentTenPutawayBinding
    ...
    fun fabClickedData() {
        ...
        val mMap = ArrayMap<String, String>().apply {
            put("w10aisle", binding.editAisle?.text.toString())
        }

        listener?.onFabInteraction(10, listofButton , mMap)
    }
    ...
    override fun onCreateView(
        ...
        binding = FragmentTenPutawayBinding.inflate(inflater,container,false)
//        val rootView = inflater.inflate(R.layout.fragment_ten_putaway, container, false)
//        tv_wareHouse = rootView.findViewById<TextView>(R.id.tv_wareHouse)
//        edit_aisle = rootView.findViewById<EditText>(R.id.edit_aisle)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (mMineUserEntity != null && mMineUserEntity.Output != null) {
            ...
            if (!mMineUserEntity.Output.des02.isNullOrEmpty()) {
                //edit_aisle?.setText(mMineUserEntity.Output.des02)
            }
    ...
    companion object {
         ...
         * @return A new instance of fragment TenPutawayFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            TenPutawayFragment().apply {
    ...
    override fun onDestroyView() {
        super.onDestroyView()
        PutAwayBaseActivity.currentFragment = TenPutawayFragment()
    }
    ...
    fun onNextClick(btnValue: String) {
        ...
        listener?.onNextInteraction(10, btnValue, mMap)
    }

    fun updateUiOnScan(decodedData: String) {
        binding.editAisle?.setText(decodedData)
