...
import com.bfc.putaway.databinding.FragmentSevenPutawayBinding
 ...
 * Use the [SevenPutawayFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class SevenPutawayFragment : Fragment() {
    // TODO: Rename and change types of parameters
    private var param1: String? = null
    private var param2: String? = null
//    private var tv_goToZone: TextView? = null
//    private var edit_scanZone: EditText? = null
    private lateinit var binding: FragmentSevenPutawayBinding
    ...
    fun fabClickedData() {
        ...
        val mMap = ArrayMap<String, String>().apply {
            put("scanSlot", binding.editScanZone?.text.toString())
        }

        listener?.onFabInteraction(7, listofButton,mMap)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (mMineUserEntity != null && mMineUserEntity.Output != null) {
            if (!mMineUserEntity.Output.des01.isNullOrEmpty()) {
                binding.tvGoToZone?.text = mMineUserEntity.Output.des01
            }

            if (!mMineUserEntity.Output.des02.isNullOrEmpty()) {
                //edit_scanZone?.setText(mMineUserEntity.Output.des02)
            }
    ...
    override fun onCreateView(
        ...
        binding = FragmentSevenPutawayBinding.inflate(inflater,container,false)
//        val rootView = inflater.inflate(R.layout.fragment_seven_putaway, container, false)
//        tv_goToZone = rootView.findViewById<TextView>(R.id.tv_goToZone)
//        edit_scanZone = rootView.findViewById<EditText>(R.id.edit_scanZone)
        return binding.root
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment SevenPutawayFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            SevenPutawayFragment().apply {
    ...
    override fun onDestroyView() {
        super.onDestroyView()
        PutAwayBaseActivity.currentFragment = SevenPutawayFragment()
    }
    ...
    fun onNextClick(btnValue: String) {
        ...
        listener?.onNextInteraction(7, btnValue, mMap)
    }

    fun updateUiOnScan(decodedData: String) {
        binding.editScanZone?.setText(decodedData)
