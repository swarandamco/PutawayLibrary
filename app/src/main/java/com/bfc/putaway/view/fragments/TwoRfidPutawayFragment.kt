...
import com.bfc.putaway.databinding.FragmentTwoRfidPutawayBinding
 ...
 * Use the [TwoRfidPutawayFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class TwoRfidPutawayFragment : Fragment() {
    // TODO: Rename and change types of parameters
    private var param1: String? = null
    private var param2: String? = null
    private lateinit var binding: FragmentTwoRfidPutawayBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentTwoRfidPutawayBinding.inflate(inflater,container,false)
        return binding.root
    }
...
//        if (!mMineUserEntity.Output.head1.isNullOrEmpty()) {
            (activity as MainActivityPutAway).setScreenDetail("Looking For Slot")
//        }
    ...
    override fun onDestroyView() {
        super.onDestroyView()
        PutAwayBaseActivity.currentFragment = TwoRfidPutawayFragment()
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment TwoRfidPutawayFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            TwoRfidPutawayFragment().apply {
