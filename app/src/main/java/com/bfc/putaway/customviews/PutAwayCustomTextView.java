...
public class PutAwayCustomTextView extends AppCompatTextView {
    private Context context;

    public PutAwayCustomTextView(Context context) {
        super(context);
        FontUtils.setFontFace(context, this, FontUtils.FontType.POPPINSREGULAR.toString());
        this.context = context;
    }

    public PutAwayCustomTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        if (!isInEditMode()) {
